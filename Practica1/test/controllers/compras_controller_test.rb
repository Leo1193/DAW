...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { fecha: @compra.fecha, monto: @compra.monto, nombre: @compra.nombre } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { fecha: @compra.fecha, monto: @compra.monto, nombre: @compra.nombre } }
